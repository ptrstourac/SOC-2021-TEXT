...
Pro výuku SolidWorks\superscript{\cite{SOLIDWORKS}}, který je jedním z~nejčastěji používaných CADů, aktuálně existuje pouze jedna učebnice\superscript{\cite{PAGAC}} v češtině.
...
Proto, aby byla celá sada snadno a rychle dostupná, jsem následně přidal i webový portál P3D\superscript{\cite{P3DPORTAL}}, na kterém jsou všechny její dílčí části volně k~dispozici.
